...
| `aa-batteries_2x1.stl` | Staggered hex organizer: 9× AA + 5× AAA (cylindrical pockets) | 84 × 42 mm, ~35mm tall |
...
# Generated by generate_batteries.py (custom build123d script)
python3 generate_batteries.py  # outputs aa-batteries_2x1.stl
```
